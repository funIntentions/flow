...
public class CompositeStructure extends Structure
{
    ...
    {
        super(structureName, StructureType.COMPOSITE_UNIT, new ArrayList<PropertyModel>(), new ArrayList<Device>(), new ArrayList<Device>(), new ArrayList<Device>());
    ...
    {
        super(structure, StructureType.COMPOSITE_UNIT, propertyList, new ArrayList<Device>(), new ArrayList<Device>(), new ArrayList<Device>());
    }

    public CompositeStructure(Structure structure)
    {
        super(structure.getName(), structure.getType(), structure.getProperties(), structure.getAppliances(), structure.getEnergySources(), structure.getEnergyStorageDevices());
        numberOfUnits = 0;
