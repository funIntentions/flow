 ...
 */
public class ObjectPropertyPanel extends JScrollPane implements SubscribedView
{
    ...
    public ObjectPropertyPanel(MouseAdapter mouseAdapter)
    {
    ...
    {
        if (event.getPropertyName().equals(OntologyModel.PC_NEW_ONTOLOGY_OBJECT_PROPERTIES_LOADED))
        {
